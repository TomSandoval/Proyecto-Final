...
export default function FilterButtons(){
    ...
    return (
        <div className="filter-buttons-container">
            ...
            {
                categories?.map((c,index) => <Link to={`/categories/${c.name}`} key={index} className="button-filter"><img className="filter-image" src={c.img}/><p key={index} className="filter-title">{c.name}</p></Link>)
            }

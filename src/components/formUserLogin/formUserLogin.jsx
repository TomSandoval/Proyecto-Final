        ...
        <div className={styles.container}>
            ...
            <div className={styles.div}  >
                <form action='/login' method='POST' onSubmit={(e) => handleSubmit(e)} className={styles.divForm}>
                    ...
                    <div className={styles.divAlreadyRegister}>
                        <Link to={'/formRegister'} className={styles.noRegister} >No tengo Cuenta</Link>
                    </div>
                    <div className={styles.divAlreadyRegister}>
                        <button className={styles.buttonGuest}><Link to='/' className={styles.link}>Continuar como Invitado</Link></button>
                    </div>
                </form>
            </div>
